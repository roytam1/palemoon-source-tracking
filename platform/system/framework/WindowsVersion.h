...
// Windows 10 - Threshold 2 - November Update
MOZ_ALWAYS_INLINE bool
IsWin10v1511OrLater()
{
...
// Windows 10 - Redstone 5 - October 2018 Update
MOZ_ALWAYS_INLINE bool
IsWin10v1809OrLater()
{
...
IsWin11OrLater()
{
  // Windows 11 identifies its self as NT 10 so we can only continue the Windows 10
  // build number checking like nothing changed.
  return IsWindows10BuildOrLater(22000);
}

// These are Mozilla's Windows 10 identifiers for potential porting compatibility..
// They should -NOT- be used by us, so says the New Tobin Paradigm.
MOZ_ALWAYS_INLINE bool IsWin10November2015UpdateOrLater() { return IsWin10v1511OrLater(); }
MOZ_ALWAYS_INLINE bool IsWin10AnniversaryUpdateOrLater() { return IsWin10v1607OrLater(); }
MOZ_ALWAYS_INLINE bool IsWin10CreatorsUpdateOrLater() { return IsWin10v1703OrLater(); }
MOZ_ALWAYS_INLINE bool IsWin10FallCreatorsUpdateOrLater() { return IsWin10v1709OrLater(); }
MOZ_ALWAYS_INLINE bool IsWin10April2018UpdateOrLater() {  return IsWin10v1803OrLater(); }
MOZ_ALWAYS_INLINE bool IsWin10Sep2018UpdateOrLater() { return IsWin10v1809OrLater(); }
MOZ_ALWAYS_INLINE bool IsWin10May2019UpdateOrLater() { return IsWin10v1903OrLater(); }
